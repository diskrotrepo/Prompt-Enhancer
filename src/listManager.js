...
export let NEG_PRESETS = {};
export let POS_PRESETS = {};
export let LENGTH_PRESETS = {};
export let DIVIDER_PRESETS = {};
export let BASE_PRESETS = {};
export let LYRICS_PRESETS = {};
...
export function importLists(obj, additive = false) {
...
export function loadListsFromFile(file, additive = false) {
