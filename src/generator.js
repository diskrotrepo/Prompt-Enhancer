import { shuffle, equalizeLength } from './utils.js';

export function buildPrefixedList(
  orderedItems,
  prefixes,
  limit,
...
export function applyNegativeOnPositive(
  posTerms,
  negMods,
  limit,
  stackSize = 1,
...
export function processLyrics(text, maxSpaces, removeParens = false, removeBrackets = false) {
  if (!text) return '';
