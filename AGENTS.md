...
The UI is a Windows 3.1 style desktop (teal wallpaper, silver beveled windows, navy active title bars); see the Theme section in `src/AGENTS.md` before changing styles so new controls reuse the shared `--w31-*` tokens and bevel recipes.
